...
// ── Nội dung riêng của Bài 1. Tập hợp các số hữu tỉ ───────────────
#let TEN = [Bài 1. Tập hợp các số hữu tỉ]
...
#dau-phieu(TEN, "01", [Toán 7 · Chương I — Số hữu tỉ])

// ══════════════════════════════════════════════════════════════════
#sec("1", "Hệ thống kiến thức")

#sub("Số hữu tỉ · Số đối")
#lythuyet(
  ([*Số hữu tỉ* là số viết được dưới dạng gì? Tập hợp các số hữu tỉ kí hiệu là gì?], 3),
  ([Vì sao số nguyên, số thập phân và hỗn số đều là số hữu tỉ?], 3),
  ([*Số đối* của số hữu tỉ $m$ là số nào?], 2))

#sub("Biểu diễn trên trục số · So sánh")
#lythuyet(
  ([Muốn biểu diễn $a/b$ trên trục số, ta chia đoạn thẳng đơn vị thế nào rồi đếm ra sao?], 4),
  ([Muốn *so sánh* hai số hữu tỉ, ta làm thế nào?], 3),
  ([Trên trục số, số hữu tỉ âm nằm ở đâu, số hữu tỉ dương nằm ở đâu? Số $0$ thì sao?], 3))

// ══════════════════════════════════════════════════════════════════
#sec("2", "Ví dụ · Luyện tập")

#prob(c-vd, "Ví dụ 1",
  [Các số $-7$; $dc("0,6")$; $-dc("1,2")$; $1 4/5$ có là số hữu tỉ không? Vì sao?], 5)

#prob(c-lt, "Luyện tập 1",
  [Giải thích vì sao các số $8$; $-#dc("3,3")$; $3 2/3$ đều là số hữu tỉ. Tìm số đối của mỗi số đó.], 6)

#block(breakable: false, {
  tag(c-lt, "Luyện tập 2"); h(2mm)
  [Biểu diễn hai số hữu tỉ $5/4$ và $-5/4$ trên trục số dưới đây. Em hãy chia mỗi đoạn thẳng đơn vị thành bốn phần bằng nhau rồi đánh dấu hai điểm.]
  v(1.6mm)
...
#prob(c-lt, "Luyện tập 3",
  [Sắp xếp các số hữu tỉ sau theo thứ tự từ nhỏ đến lớn: $5 1/4$; $-2$; $dc("3,125")$; $-3/2$.], 6)

#prob(c-vdung, "Vận dụng",
  [Chỉ số WHtR bằng tỉ số giữa số đo vòng bụng và số đo chiều cao. Ông An cao $180$ cm, vòng bụng $108$ cm; ông Chung cao $160$ cm, vòng bụng $70$ cm. Biết WHtR từ $dc("0,42")$ đến $dc("0,52")$ là mức tốt, trên $dc("0,57")$ đến $dc("0,63")$ là thừa cân. Theo chỉ số WHtR, sức khoẻ của ai tốt hơn?], 8)

// ══════════════════════════════════════════════════════════════════
#sec("3", "Bài tập · SGK tr.9")
...
#block(breakable: false, {
  tag(c-bt, "Bài 1.3"); h(2mm)
  [Các điểm $A$, $B$, $C$, $D$ trong hình dưới đây biểu diễn những số hữu tỉ nào?]
  v(1.6mm)
  trucso(-1.5, 1.5, 6, ((-1, "−1"), (0, "0"), (1, "1")),
    diem: ((-7/6, "A"), (-1/3, "B"), (1/2, "C"), (4/3, "D")))
  v(0.4mm)
  align(center, text(size: 9pt, fill: muted)[Hình 1.7])
})
#dots(5)

#block(breakable: false, {
  tag(c-bt, "Bài 1.4"); h(2mm)
  [a) Trong các phân số sau, những phân số nào biểu diễn số hữu tỉ $-#dc("0,625")$?]
  v(1mm)
  align(center)[$5/(-8)$ #h(7mm) $10/16$ #h(7mm) $20/(-32)$ #h(7mm) $(-10)/16$ #h(7mm) $(-25)/40$ #h(7mm) $35/(-48)$]
})
#dots(4)
#block(breakable: false, {
  [b) Biểu diễn số hữu tỉ $-#dc("0,625")$ trên trục số dưới đây.]
  v(1.4mm)
  trucso(-1.5, 1, 1, ((-1, "−1"), (0, "0"), (1, "1")))
})
#dots(2)

#probm(c-bt, "Bài 1.5",
  [So sánh:],
  ("a)", [$-#dc("2,5")$ và $-#dc("2,125")$;], 3),
  ("b)", [$-1/10000$ và $1/23456$.], 3))

#block(breakable: false, {
  tag(c-bt, "Bài 1.6"); h(2mm)
  [Tuổi thọ trung bình dự kiến của những người sinh năm 2019 ở một số quốc gia được cho trong bảng sau. Hãy sắp xếp các quốc gia theo tuổi thọ trung bình dự kiến từ nhỏ đến lớn.]
  v(1.6mm)
  table(columns: (1.5fr, 1fr, 1fr, 1.3fr, 1fr, 1fr),
    stroke: 0.6pt + hair, align: center + horizon, inset: (x: 2mm, y: 2.2mm),
    hcell([Quốc gia]), hcell([Australia]), hcell([Pháp]), hcell([Tây Ban Nha]),
      hcell([Anh]), hcell([Mỹ]),
    text(size: 11.5pt)[Tuổi thọ trung bình], $83$, $#dc("82,5")$, $83 1/5$, $81 2/5$, $78 1/2$)
})
#dots(6)
...
#prob(c-lt, "Bài 1",
  [Viết mỗi số sau thành phân số tối giản có mẫu dương: $(-18)/(-24)$; $#dc("1,44")$; $-2 3/8$.], 8)

#prob(c-lt, "Bài 2",
  [Tìm tất cả các số nguyên $x$ sao cho $-7/3 < x < 5/4$.], 7)

#prob(c-lt, "Bài 3",
  [Trên một trục số, đoạn thẳng đơn vị được chia thành $6$ phần bằng nhau. Điểm $M$ nằm trước gốc $O$ và cách $O$ mười đơn vị mới, điểm $N$ nằm sau gốc $O$ và cách $O$ tám đơn vị mới. Hãy viết số hữu tỉ mà mỗi điểm biểu diễn rồi so sánh hai số đó.], 9)

#prob(c-lt, "Bài 4",
  [Nhiệt độ thấp nhất trong một ngày mùa đông ở bốn địa điểm lần lượt là $-#dc("1,5")$ °C; $-3/2$ °C; $-#dc("0,8")$ °C; $-7/4$ °C. Có hai địa điểm cùng một nhiệt độ — đó là hai địa điểm nào? Sắp xếp bốn số đó từ nhỏ đến lớn.], 8)
