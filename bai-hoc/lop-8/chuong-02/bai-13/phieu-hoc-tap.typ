// ══════════════════════════════════════════════════════════════════
//  PHIẾU HỌC TẬP — Bài 9. Phân tích đa thức thành nhân tử (Toán 8)
  ...
  header: context {
    if counter(page).get().first() > 1 {
      ...
      grid(columns: (1fr, auto),
        [Bài 9. Phân tích đa thức thành nhân tử — Phiếu học tập], [Toán 8])
      v(-1mm)
  ...
  grid(columns: (1fr, auto), align: (left + horizon, right + horizon),
    {
      ...
      v(1.4mm)
      text(fill: primaryd, font: display, weight: 800, size: 24pt)[Bài 9. Phân tích đa thức thành nhân tử]
      v(1.2mm)
      text(fill: muted, size: 11.5pt)[Toán 8 · Chương II — Hằng đẳng thức đáng nhớ và ứng dụng]
    },
    text(font: display, weight: 800, size: 42pt, fill: primary.transparentize(72%))[13]))
...
#sec("1", "Phân tích đa thức thành nhân tử")
#sub("Em tự hoàn thiện kiến thức")
#lythuyet(
  ([*Khái niệm:* Phân tích đa thức thành nhân tử là biến đổi đa thức thành dạng nào?], 4),
  ([*Đặt nhân tử chung:* Nêu cách tìm nhân tử chung của hệ số và phần biến.], 6),
  ([*Dùng hằng đẳng thức và nhóm:* Nêu dấu hiệu nhận biết, yêu cầu phân tích triệt để.], 7))


#sec("2", "Ba phương pháp cơ bản")
#probm(c-lt, "Luyện tập 1", [Phân tích thành nhân tử.],
  ("a)", [$6x^3 y - 9x^2 y^2$], 6),
  ("b)", [$x^2 - 10x + 25$], 6),
  ("c)", [$8a^3 - 27b^3$], 7))
#probm(c-lt, "Luyện tập 2", [Phân tích bằng cách nhóm.],
  ("a)", [$x y + 4x + 3y + 12$], 7),
  ("b)", [$2x^2 - 6x y + x - 3y$], 7))


#sec("3", "Phân tích triệt để")
#probm(c-vdung, "Vận dụng 1", [Phân tích triệt để.],
  ("a)", [$x^3 - 4x$], 7),
  ("b)", [$x^4 - 16$], 8),
  ("c)", [$x^4 - 8x$], 8))
#prob(c-vdung, "Vận dụng 2",
  [Giải phương trình $3x^2 - 12x = 0$ bằng cách phân tích vế trái thành nhân tử.], 8)


#sec("4", "Củng cố")
#probm(c-bt, "Bài tổng hợp", [Cho $A = x^2 + 2y - 2x - x y$.],
  ("a)", [Phân tích $A$ thành nhân tử.], 7),
  ("b)", [Tính nhanh $A$ tại $x = 2026, y = 2024$.], 4),
  ("c)", [Tìm $x$ để $A = 0$ khi $y = 3$.], 7))
#prob(c-bt, "Thử thách",
  [Phân tích triệt để $x^3 - x$ và giải thích vì sao $x(x^2 - 1)$ chưa phải kết quả cuối cùng.], 8)
