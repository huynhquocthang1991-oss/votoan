// ══════════════════════════════════════════════════════════════════
//  PHIẾU HỌC TẬP — Bài 6. Hiệu hai bình phương. Bình phương của một tổng hay một hiệu (Toán 8)
  ...
  header: context {
    if counter(page).get().first() > 1 {
      ...
      grid(columns: (1fr, auto),
        [Bài 6. Hiệu hai bình phương. Bình phương của một tổng hay một hiệu — Phiếu học tập], [Toán 8])
      v(-1mm)
  ...
  grid(columns: (1fr, auto), align: (left + horizon, right + horizon),
    {
      ...
      v(1.4mm)
      text(fill: primaryd, font: display, weight: 800, size: 24pt)[Bài 6. Hiệu hai bình phương. Bình phương của một tổng hay một hiệu]
      v(1.2mm)
      text(fill: muted, size: 11.5pt)[Toán 8 · Chương II — Hằng đẳng thức đáng nhớ và ứng dụng]
    },
    text(font: display, weight: 800, size: 42pt, fill: primary.transparentize(72%))[09]))
...
#sec("1", "Hằng đẳng thức và ba công thức đầu")
#sub("Em tự hoàn thiện kiến thức")
#lythuyet(
  ([*Hằng đẳng thức:* Khi nào đẳng thức $A = B$ đúng với mọi giá trị của biến?], 4),
  ([*Hiệu hai bình phương:* Viết công thức và nêu dấu hiệu nhận biết.], 4),
  ([*Bình phương của một tổng, một hiệu:* Viết hai công thức và chỉ ra hạng tử giữa.], 7))


#sec("2", "Nhận dạng và khai triển")
#probm(c-lt, "Luyện tập 1", [Khai triển hoặc phân tích thành nhân tử.],
  ("a)", [$(2x + 3y)^2$], 6),
  ("b)", [$(5a - b)^2$], 6),
  ("c)", [$9x^2 - 16y^2$], 6))
#probm(c-lt, "Luyện tập 2", [Điền biểu thức thích hợp vào ô trống.],
  ("a)", [$x^2 + 10x + dots = (x + dots)^2$], 4),
  ("b)", [$dots - 12x y + 9y^2 = (2x - dots)^2$], 4))


#sec("3", "Tính nhanh và rút gọn")
#probm(c-vdung, "Vận dụng 1", [Tính nhanh bằng hằng đẳng thức.],
  ("a)", [$98 dot 102$], 6),
  ("b)", [$1003^2$], 6),
  ("c)", [$507^2 - 493^2$], 6))
#prob(c-vdung, "Vận dụng 2",
  [Rút gọn $(x - 4y)^2 - (x + 4y)^2$ và kiểm tra kết quả tại $x = 3, y = -1$.], 10)


#sec("4", "Củng cố")
#probm(c-bt, "Bài tổng hợp", [Cho $P = (3x - 2)^2 - (3x - 2)(3x + 2)$.],
  ("a)", [Rút gọn $P$.], 7),
  ("b)", [Tính $P$ tại $x = -2$.], 4),
  ("c)", [Tìm $x$ để $P = 20$.], 7))
#prob(c-bt, "Thử thách",
  [Chứng minh rằng $(n + 2)^2 - n^2$ chia hết cho $4$ với mọi số tự nhiên $n$.], 8)
