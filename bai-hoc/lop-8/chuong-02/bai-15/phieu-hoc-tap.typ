// ══════════════════════════════════════════════════════════════════
//  PHIẾU HỌC TẬP — Bài tập cuối chương II (Toán 8)
  ...
  header: context {
    if counter(page).get().first() > 1 {
      ...
      grid(columns: (1fr, auto),
        [Bài tập cuối chương II — Phiếu học tập], [Toán 8])
      v(-1mm)
  ...
  grid(columns: (1fr, auto), align: (left + horizon, right + horizon),
    {
      ...
      v(1.4mm)
      text(fill: primaryd, font: display, weight: 800, size: 24pt)[Bài tập cuối chương II]
      v(1.2mm)
      text(fill: muted, size: 11.5pt)[Toán 8 · Chương II — Hằng đẳng thức đáng nhớ và ứng dụng]
    },
    text(font: display, weight: 800, size: 42pt, fill: primary.transparentize(72%))[15]))
...
#sec("1", "Hệ thống kiến thức Chương II")
#sub("Em tự lập bản đồ kiến thức")
#lythuyet(
  ([*Bảy hằng đẳng thức đáng nhớ:* Chia thành ba nhóm và viết đủ công thức.], 10),
  ([*Phân tích đa thức thành nhân tử:* Ba phương pháp và trình tự nên thử.], 7),
  ([*Tự kiểm tra:* Làm thế nào để biết kết quả khai triển hoặc phân tích đúng?], 4))


#sec("2", "Hằng đẳng thức")
#probm(c-bt, "Bài 1", [Thực hiện.],
  ("a)", [Tính nhanh $102^2 - 4 dot 102 + 4$.], 6),
  ("b)", [Rút gọn $(2x - 5y)(2x + 5y) + (2x + 5y)^2$.], 8),
  ("c)", [Phân tích $64x^3 - 27y^3$ thành nhân tử.], 7))
#prob(c-bt, "Bài 2",
  [Rút gọn $(x + 2y)(x^2 - 2x y + 4y^2) + (2x - y)(4x^2 + 2x y + y^2)$.], 10)


#sec("3", "Phân tích đa thức")
#probm(c-bt, "Bài 3", [Phân tích triệt để.],
  ("a)", [$6x^2 - 24y^2$], 7),
  ("b)", [$x^4 - 2x^3 + x^2$], 7),
  ("c)", [$(x - y)^3 + 8y^3$], 8))
#prob(c-bt, "Bài 4",
  [Phân tích $x^2 - 9x + 8$ thành tích của hai nhị thức và kiểm tra lại bằng phép nhân.], 8)


#sec("4", "Vận dụng tổng hợp")
#probm(c-vdung, "Bài 5", [Cho hình vuông cạnh $a + b$ được chia thành một hình vuông cạnh $a$, một hình vuông cạnh $b$ và hai hình chữ nhật kích thước $a$ và $b$.],
  ("a)", [Tính diện tích hình vuông lớn theo cạnh.], 4),
  ("b)", [Tính tổng diện tích bốn phần.], 6),
  ("c)", [Từ hai cách tính, giải thích hằng đẳng thức thu được.], 7))
#prob(c-vdung, "Bài 6",
  [Cho $P = (2x + 1)^3 - 6x(2x + 1)$. Rút gọn $P$, rồi tính tại $x = 49$.], 10)
