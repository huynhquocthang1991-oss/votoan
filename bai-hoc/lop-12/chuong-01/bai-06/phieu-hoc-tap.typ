...
// ── Nội dung riêng của Bài tập cuối chương I ──
#let TEN = [Bài tập cuối chương I]
...
#dau-phieu(TEN, "06", [Toán 12 · Chương I — Ứng dụng đạo hàm])

#sec("1", "Tổng kết chương I")

#lythuyet(
  ([*Đơn điệu và cực trị:* dấu của $f'(x)$ cho biết điều gì? Khi nào $x_0$ là điểm cực trị?], 4),
  ([*Giá trị lớn nhất, nhỏ nhất:* cách làm trên một đoạn khác cách làm trên một khoảng ở chỗ nào?], 4),
  ([*Ba loại tiệm cận:* viết điều kiện của tiệm cận ngang, tiệm cận đứng và tiệm cận xiên.], 5),
  ([*Khảo sát hàm số:* ba bước; tâm đối xứng của đồ thị hàm bậc ba và của hàm phân thức.], 5))

#sec("2", "Câu hỏi trắc nghiệm · SGK tr.42 – 43")

#prob(c-bt, "Bài 1.31",
  [Hàm số nào sau đây nghịch biến trên $RR$? Giải thích lựa chọn.
  #v(1mm) A. $y = -x^3 + 3x^2 - 9x$. #h(6mm) B. $y = -x^3 + x + 1$.
  #v(0.8mm) C. $y = (x - 1)/(x - 2)$. #h(10mm) D. $y = 2x^2 + 3x + 2$.], 7)

#prob(c-bt, "Bài 1.33",
  [Tìm giá trị cực tiểu của hàm số $y = x^2 ln x$.], 9)

#prob(c-bt, "Bài 1.34",
  [Tìm giá trị lớn nhất của hàm số $y = (x - 2)^2 dot e^x$ trên đoạn $[1; 3]$.], 9)

#prob(c-bt, "Bài 1.36",
  [Tìm tiệm cận xiên của đồ thị hàm số $y = (x^2 + 2x - 2)/(x + 2)$.], 8)

#sec("3", "Bài tập tự luận · SGK tr.43 – 44")

#probm(c-bt, "Bài 1.40", [Xét chiều biến thiên và tìm các cực trị (nếu có) của các hàm số sau:],
  ("a)", [$y = x^3 - 3x^2 + 3x - 1$;], 7),
  ("b)", [$y = x^4 - 2x^2 - 1$;], 10),
  ("c)", [$y = (2x - 1)/(3x + 1)$;], 7),
  ("d)", [$y = (x^2 + 2x + 2)/(x + 1)$.], 11))

#probm(c-bt, "Bài 1.41", [Tìm giá trị lớn nhất và giá trị nhỏ nhất (nếu có) của các hàm số sau:],
  ("a)", [$y = (2x + 1)/(3x - 2)$ trên nửa khoảng $[2; +oo)$;], 9),
  ("b)", [$y = sqrt(2 - x^2)$.], 8))

#probm(c-bt, "Bài 1.42", [Tìm các tiệm cận của mỗi đồ thị hàm số sau:],
  ("a)", [$y = (3x - 2)/(x + 1)$;], 8),
  ("b)", [$y = (x^2 + 2x - 1)/(2x - 1)$.], 11))

#prob(c-bt, "Bài 1.43a",
  [Khảo sát sự biến thiên và vẽ đồ thị của hàm số $y = -x^3 + 6x^2 - 9x + 12$.], 16)

#prob(c-bt, "Bài 1.43c",
  [Khảo sát sự biến thiên và vẽ đồ thị của hàm số $y = (x^2 - 2x)/(x - 1)$.], 17)

#prob(c-bt, "Bài 1.45",
  [Dân số một quốc gia sau $t$ năm kể từ $2023$ là $N(t) = 100 e^(dc("0,012") t)$ (triệu người), $0 <= t <= 50$. Ước tính dân số năm $2030$ và $2035$; xét chiều biến thiên của $N(t)$; vào năm nào tốc độ tăng dân số là $dc("1,6")$ triệu người mỗi năm?], 14)

#prob(c-bt, "Bài 1.46",
  [Nhà máy điện ở $A$, hòn đảo ở $C$; $B C = 4$ km, $A B = 10$ km và góc $B$ vuông. Chi phí $1$ km dây trên biển là $50$ triệu đồng, trên đất liền là $30$ triệu đồng. Xác định điểm $M$ trên $A B$ để tổng chi phí nhỏ nhất.], 15)

#sec("4", "Tự luyện thêm")

#prob(c-lt, "Bài 1",
  [Tìm $m$ để hàm số $y = x^3 - 3 m x^2 + 3(2m - 1) x + 1$ đồng biến trên $RR$.], 12)

#prob(c-lt, "Bài 2",
  [Tìm các tiệm cận của đồ thị hàm số $y = (2x^2 - 3x + 1)/(x - 1)$.], 7)

#prob(c-lt, "Bài 3",
  [Tìm giá trị lớn nhất và giá trị nhỏ nhất của hàm số $y = x + 4/x$ trên đoạn $[1; 3]$.], 8)

#prob(c-lt, "Bài 4",
  [Một công ty ước tính lợi nhuận khi bán $x$ sản phẩm mỗi tháng là $L(x) = -x^3 + 24 x^2 - 45 x$ (triệu đồng), $x >= 0$. Tìm số sản phẩm cần bán để lợi nhuận lớn nhất.], 10)
