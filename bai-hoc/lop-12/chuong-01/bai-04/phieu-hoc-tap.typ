...
// ── Nội dung riêng của Bài 4. Khảo sát sự biến thiên và vẽ đồ thị của hàm số ──
#let TEN = [Bài 4. Khảo sát sự biến thiên và vẽ đồ thị của hàm số]
...
#dau-phieu(TEN, "04", [Toán 12 · Chương I — Ứng dụng đạo hàm])

#sec("1", "Sơ đồ khảo sát hàm số")

#lythuyet(
  ([Bước 1 của sơ đồ khảo sát hàm số là gì?], 2),
  ([Bước 2 gồm những việc nào? Ghi đủ năm gạch đầu dòng.], 6),
  ([Bước 3 vẽ đồ thị: ngoài bảng biến thiên còn cần xác định thêm những gì?], 4))

#sec("2", "Hàm số đa thức bậc ba")

#prob(c-vd, "Ví dụ 1",
  [Khảo sát sự biến thiên và vẽ đồ thị của hàm số $y = -x^3 + 3x^2 - 4$.], 16)

#prob(c-lt, "Luyện tập 1",
  [Khảo sát sự biến thiên và vẽ đồ thị của hàm số $y = x^3 - 2x^2 + 2x - 1$.], 16)

#sec("3", "Hàm phân thức bậc nhất trên bậc nhất")

#lythuyet(
  ([Đồ thị hàm số $y = (a x + b)/(c x + d)$ nhận điểm nào làm *tâm đối xứng*?], 3),
  ([Hai đường nào là *trục đối xứng* của đồ thị đó?], 2))

#prob(c-vd, "Ví dụ 2",
  [Khảo sát sự biến thiên và vẽ đồ thị của hàm số $y = (x + 1)/(x - 2)$.], 16)

#prob(c-vdung, "Vận dụng",
  [Một bể chứa ban đầu có $200$ lít nước. Mỗi phút người ta bơm thêm $40$ lít nước và cho vào bể $20$ gam chất khử trùng. Tính nồng độ chất khử trùng sau $t$ phút, khảo sát sự biến thiên của hàm số đó và giải thích vì sao nồng độ không vượt quá $dc("0,5")$ gam/lít.], 14)

#sec("4", "Hàm phân thức bậc hai trên bậc nhất")

#prob(c-vd, "Ví dụ 3",
  [Khảo sát sự biến thiên và vẽ đồ thị của hàm số $y = (x^2 - x - 1)/(x - 2)$.], 18)

#prob(c-lt, "Luyện tập 2",
  [Khảo sát sự biến thiên của hàm số $y = (-x^2 + 3x - 1)/(x - 2)$.], 14)

#sec("5", "Bài tập · SGK tr.32")

#prob(c-bt, "Bài 1.21b",
  [Khảo sát sự biến thiên và vẽ đồ thị của hàm số $y = x^3 + 3x^2 - x - 1$.], 15)

#prob(c-bt, "Bài 1.22b",
  [Khảo sát sự biến thiên và vẽ đồ thị của hàm số $y = (x + 3)/(1 - x)$.], 14)

#prob(c-bt, "Bài 1.23b",
  [Khảo sát sự biến thiên và vẽ đồ thị của hàm số $y = (x^2 + 2x + 1)/(x + 3)$.], 17)

#prob(c-bt, "Bài 1.24",
  [Một cốc chứa $30$ ml dung dịch KOH nồng độ $100$ mg/ml. Trộn thêm $x$ ml dung dịch KOH nồng độ $8$ mg/ml. Tính nồng độ $C(x)$, khảo sát sự biến thiên và giải thích vì sao nồng độ luôn lớn hơn $8$ mg/ml.], 14)

#sec("6", "Tự luyện thêm")

#prob(c-lt, "Bài 1",
  [Khảo sát sự biến thiên và vẽ đồ thị của hàm số $y = x^3 - 3x^2 + 2$.], 10)

#prob(c-lt, "Bài 2",
  [Khảo sát sự biến thiên và vẽ đồ thị của hàm số $y = (3x - 1)/(x - 2)$.], 9)

#prob(c-lt, "Bài 3",
  [Tìm toạ độ tâm đối xứng của đồ thị hàm số $y = 2x^3 - 6x^2 + 5$.], 4)
